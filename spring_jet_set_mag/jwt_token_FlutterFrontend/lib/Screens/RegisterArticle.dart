...
class RegArticle extends StatefulWidget {
  @override
  _RegArtState createState() => _RegArtState();
}

class _RegArtState extends State<RegArticle> {
  ...
  save(String titre, String description) async {
    ...
    var response = await http.post(
        "http://localhost:30000/api/auth/restArticle/articles",
        body: msg,
        headers: headers);
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    _textInput(hint: "titre", icon: Icons.category),
